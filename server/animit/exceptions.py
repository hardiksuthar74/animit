...
class AnimitError(Exception):
    """
    Base exception class for all errors raised by Animit.
...
class AnimitTaskError(AnimitError):
    """
...
class AnimitRedirectionError(AnimitError):
    """
...
class InternalServerError(AnimitError):
    def __init__(
...
class ResourceNotFound(AnimitError):
...
class AnimitRequestValidationError(AnimitError):
